        ...
        >
          ...
          >
            <div className="relative bg-white/5 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-spiritual-gold/20">
              ...
              <motion.blockquote
                className="font-serif text-2xl md:text-3xl lg:text-4xl text-gradient-gold leading-relaxed mb-8 font-bold"
                initial={{ opacity: 0 }}
                animate={inView ? { opacity: 1 } : {}}
              ...
              >
                ...
                <cite className="font-black text-xl text-gradient-white">— Abhishek</cite>
                <div className="h-px bg-gradient-to-r from-transparent via-spiritual-gold to-transparent flex-1 max-w-32" />
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="font-serif text-xl font-black text-gradient-white mb-2 drop-shadow-lg">
                  {vision.title}
                </h3>
